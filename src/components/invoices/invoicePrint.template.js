...
const PRINT_CSS = `
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .header { display: flex; align-items: flex-start; justify-content: space-between; border-bottom: 3px solid ${AMBER}; padding-bottom: 8px; margin-bottom: 8px; }
  .hotel-block { display: flex; align-items: center; gap: 10px; }
  .hotel-name  { font-size: 17px; font-weight: bold; letter-spacing: .02em; color: ${AMBER2}; }
  .hotel-sub   { font-size: 11px; color: #555; margin-top: 2px; line-height: 1.5; }
  .doc-block   { text-align: right; min-width: 160px; }
  .doc-type    { display: inline-block; font-size: 12px; font-weight: bold; border: 2px solid ${AMBER}; color: ${AMBER2}; padding: 4px 11px; margin-bottom: 4px; letter-spacing: .04em; border-radius: 3px; }
  .doc-corr    { font-size: 11.5px; font-weight: bold; color: #333; }
  .doc-date    { font-size: 10.5px; color: #666; margin-top: 2px; }
  .cai-block   { border: 1px solid #fde68a; border-radius: 4px; padding: 6px 10px; margin-bottom: 8px; background: #fffbeb; }
  .cai-top     { margin-bottom: 5px; padding-bottom: 5px; border-bottom: 1px solid #fde68a; }
  .cai-bottom  { display: flex; gap: 12px; }
  .cai-bottom > div { flex: 1; min-width: 0; }
  .cai-lbl     { font-size: 10px; text-transform: uppercase; color: #92400e; margin-bottom: 2px; letter-spacing: .03em; }
  ...
  .info-box    { border: 1px solid #fde68a; border-radius: 4px; padding: 6px 9px; background: #fffbeb; }
  .info-title  { font-size: 10px; text-transform: uppercase; font-weight: bold; color: ${AMBER2}; border-bottom: 1px solid #fde68a; padding-bottom: 3px; margin-bottom: 4px; letter-spacing: .05em; }
  ...
  .proforma-banner { border: 2px dashed #c2410c; color: #c2410c; font-weight: bold; text-align: center; padding: 6px; margin: 4px 0; letter-spacing: 2px; border-radius: 6px; font-size: 12px; }
  ...
  thead th { background: ${AMBER}; color: #fff; padding: 6px 8px; font-size: 11px; font-weight: 600; }
  ...
  .desc-cell { width: 55%; }
  .desc-sub  { font-size: 10.5px; color: #92400e; margin-top: 2px; }
  .num   { text-align: right; white-space: nowrap; }
  .bold  { font-weight: bold; }
  .totals-wrap { display: flex; justify-content: flex-end; margin-bottom: 8px; }
  .totals-box  { min-width: 260px; border: 1px solid #fde68a; border-radius: 4px; overflow: hidden; }
  ...
  .total-grand { background: ${AMBER}; color: #fff; font-size: 12.5px; font-weight: bold; padding: 6px 10px; display: flex; justify-content: space-between; }
  .letras { border: 1px solid #fde68a; border-radius: 4px; padding: 6px 10px; margin-bottom: 8px; background: #fffbeb; }
  .letras-lbl { font-size: 10px; text-transform: uppercase; color: ${AMBER2}; margin-bottom: 2px; letter-spacing: .05em; }
  .letras-val { font-size: 11px; font-weight: bold; color: #111; font-style: italic; }
  .footer { border-top: 2px solid ${AMBER}; padding-top: 7px; margin-top: 4px; }
  .footer-cols { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 5px; }
  .footer-col  { font-size: 10px; color: #666; }
  .footer-col strong { display: block; font-size: 9.5px; text-transform: uppercase; color: ${AMBER2}; margin-bottom: 2px; letter-spacing: .04em; }
...
${hasExempt ? `<div class="exo-banner"><strong>Adquiriente Exonerado</strong>${exemptionOrders ? ` &nbsp;·&nbsp; Orden de compra exenta: <strong>${exemptionOrders}</strong>` : ""}${invoice.exemptionRegistry ? ` &nbsp;·&nbsp; Registro exonerado: <strong>${invoice.exemptionRegistry}</strong>` : ""}${invoice.sagRegistry ? ` &nbsp;·&nbsp; Registro SAG: <strong>${invoice.sagRegistry}</strong>` : ""}</div>` : ""}
